...
public class ModRecipeGenerator extends RecipeProvider {
    ...
    private void buildSawmillRecipes() {
        addSawmillRecipe(Ingredient.of(ModItems.CUTTING_BOARD.get()), new ItemStack(Items.OAK_PLANKS, 4),
                2, "oak_planks", "cutting_board");

        addSawmillRecipe(tag(ModTags.WOODEN_CABINETS), new ItemStack(Items.STICK, 10),
                3, "sticks", "cabinets");
    }

    private void buildPlantGrowthChamberRecipes() {
        addPlantGrowthChamberRecipe(Ingredient.of(ModItems.TOMATO_SEEDS.get()), new OutputItemStackWithPercentages[] {
        ...
        addPlantGrowthChamberRecipe(Ingredient.of(ModItems.ONION.get()), new OutputItemStackWithPercentages[] {
                new OutputItemStackWithPercentages(new ItemStack(ModItems.ONION.get()), new double[] {
                        1., .75, .25, .25
                })
        }, 16000, "onions", "onion");

        addPlantGrowthChamberRecipe(Ingredient.of(ModItems.CABBAGE_SEEDS.get()), new OutputItemStackWithPercentages[] {
