...
public final class ModBlocks {
    ...
    public static final DeferredItem<Item> ELECTRIC_STOVE_ITEM = ModItems.ITEMS.register("electric_stove",
    ...
    public static final DeferredBlock<Block> INDUCTION_STOVE = BLOCKS.register("induction_stove",
            () -> new InductionStoveBlock(BlockBehaviour.Properties.of().
                    requiresCorrectToolForDrops().strength(5.0f, 6.0f).sound(SoundType.METAL).
                    lightLevel(AbstractStoveBlock.LIGHT_EMISSION)));
    public static final DeferredItem<Item> INDUCTION_STOVE_ITEM = ModItems.ITEMS.register("induction_stove",
